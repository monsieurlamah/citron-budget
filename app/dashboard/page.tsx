...
import { getLastBudgets, getLastTransactions, getReachedBudget, getTotalTransactionAmount, getTotalTransactionCount, getUserBudgetData } from '../actions';
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (email) {
                ...
                setTotalCount(count)
                setReachedBudgetsRatio(reachedBudgets ?? null)
